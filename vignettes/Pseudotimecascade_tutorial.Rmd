...
Group enrichment analyzes the overrepresentation of GO terms among genes from a specific pattern (e.g., `"I"`, `"D"`, `"ID"`, etc.). The clusterProfiler::dotplot() function is used to visualize enriched GO terms.
...
### 7.2: Bin-Based Enrichment Visualization
