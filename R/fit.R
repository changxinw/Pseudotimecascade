...
fitData <- function(data, expr.cut=0.1, expr.cut.rate=0.05, pseudo.time=colnames(data), p.adjust.method="BH", new_data=data.frame(pt=seq(1, ncol(data))), verbose=TRUE, mc.cores=1){
